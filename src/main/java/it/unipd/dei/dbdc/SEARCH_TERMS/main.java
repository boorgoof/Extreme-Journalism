...
public class main {
    ...
    public static final String filePath2 = "./src/main/java/it/unipd/dei/dbdc/SEARCH_TERMS/english_stoplist_v1.txt";



    public static final String outFilePath ="./src/main/java/it/unipd/dei/dbdc/SEARCH_TERMS/output.txt";
